    ...
    <div id="main" class="main col-10" style="float: left; ">
                    ...
                    <table style="direction: rtl;background-color: #ffffff;">
                        ...
                        @foreach ($orders as $order)
                            <tr>
                                ...
                                <td>
                                    <div id="{{$order->id}}" class="col-3 sendProduct">
                                    ...
                                    <div class="col-3">
                                        <a href="/admin/listOrders/{{$order->id}}"> <img src="/logo/list.png"
                                                                                         width="25" height="25"
                                                                                         title="لیست اقلام خریداری شده"></a>
                                    </div>
                                    <div class="col-3">
                                        <a href="/admin/printForSendProduct/{{$order->id}}"> <img
                                                src="/logo/printer.png" width="25" height="25" title="مشخصات مشتری"></a>
                                    </div>
                                    <div class="col-3">
                                        <a href="/admin/cancelOrder/{{$order->id}}"> <img
        ...
        <div class="col-12"
            ...
            <div class="col-11">
                    ...
                    <table style="direction: rtl;background-color: #ffffff;">
                        ...
                        @foreach ($canceledOrders as $canceledOrder)
                            <tr>
                                ...
                                <td>{{$canceledOrder->paymentCode}}</td>
                                <td>
                                    <div class="col-4">
                                        <a href="/admin/undoCancelOrders/{{$canceledOrder->id}}"> <img
                                                src="/logo/deleteRed.png"
                                                width="25" height="25"
                                                alt="درحال پردازش"></a>
                                    </div>
                                    <div class="col-4">
                                        <a href="/admin/listOrders/{{$canceledOrder->id}}"> <img src="/logo/list.png"
                                                                                                   width="25"
                                                                                                   height="25"
                                                                                                   alt="لیست اقلام خریداری شده"></a>
                                    </div>
                                    <div class="col-4">
                                        <a href="/admin/printForSendProduct/{{$canceledOrder->id}}"> <img
                ...
                @else
                    <p style="text-align: center;font-weight: bolder;color: #e2e8f0;font-size: 15px;direction: rtl">
                        هیچ سفارش لغو شده ای وجود ندارد.</p>
                @endif
            </div>
        </div>
        <div class="col-12"
