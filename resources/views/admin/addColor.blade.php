...
@section('content')
    <div class="main">
        <div class="col-12" style="text-align: center;padding-top: 15px;">
            <a style="background-color: #363636;padding: 10px;border-radius: 5px;color: white">افزودن رنگ جدید</a>
        </div>
        <div class="blockOfInputs">
            ...
            <form method="post" name="enter" enctype="multipart/form-data" action="/admin/addColor">
                @csrf
                <div class="col-6 titleTextInput" style="display: flex;justify-content: center">
                    <div class="col-3">
                        <input name="name" style="text-align: center" class="inputText" placeholder="نام رنگ">
                    </div>
                </div>
                <div class="col-6 titleTextInput" style="display: flex;justify-content: center">
                    <input name="hexColorCode" type="color" id="colorpicker" value="#0000ff">
                </div>
